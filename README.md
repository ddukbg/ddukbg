...
- **FinOps**: Thinking a lot about achieving the best performance at the right cost.
...
- **Ethereum Mining (August 2021)**  
  Engaged in Ethereum mining using multiple GPUs. Implemented monitoring solutions using WMI Exporter and Filebeat for comprehensive log and system tracking.

- **Freelance Viral Marketing (January 2017 - November 2019)**  
  Executed CPI (Cost Per Install) and CPC (Cost Per Click) campaigns on Facebook and Instagram. Leveraged expertise in Search Engine Optimization (SEO) and developed automated viral marketing programs.

- **Generative AI Content Creation**  
  Enjoy creating content using generative AI tools like Stable Diffusion, ComfyUI, Midjourney, and Gen-3.  
  *P.S. I keep my creations private as I'm a bit shy to share them publicly (YouTube, TikTok).*

- **Automation Enthusiast**  
  I've always been passionate about workflow-based automation. Recently, I've been fascinated by building prompt-based automation agents.
...
<h2> 👋 안녕하세요, 제 GitHub에 오신 것을 환영합니다!</h2>
<table>
  <tr>
    <td>
      <img src="https://github.com/user-attachments/assets/f228b07d-9359-490e-91a5-fccd47f89d00" width="500" />
...
- **보안**:  
  ![AWS IAM](https://img.shields.io/badge/AWS_IAM-%23FF4F8B.svg?style=flat&logo=amazon-aws&logoColor=white) 
  ![ISMS Certification](https://img.shields.io/badge/ISMS-인증됨-brightgreen)

---

### 💼 주요 경험

- **클라우드 인프라 관리**: 확장 가능한 AWS 인프라를 설계하고 유지하며, 리소스 사용을 최적화하고 비용 절감 전략을 구현했습니다.
- **CI/CD 파이프라인 개발**: Jenkins, GitHub Actions, Bamboo를 사용하여 견고한 CI/CD 파이프라인을 구축하고 관리하여 배포를 간소화하고 개발자 생산성을 높였습니다.
- **모니터링 & 최적화**: Grafana와 Prometheus를 사용하여 클라우드 리소스의 종합적인 모니터링을 구현하고 시스템의 안정성과 성능을 향상시켰습니다.
- **자동화 & 스크립팅**: Slack, Zapier, AWS Chatbot 등의 도구를 활용하여 워크플로우를 자동화하고 수동 작업을 줄여 프로세스를 가속화했습니다.
- **보안 & 컴플라이언스**: ISMS 보안 인증 감사를 준비하고 관리하여 업계 표준을 준수했습니다.
...
- **FinOps**: 최고의 성능을 적절한 비용으로 달성하는 방법을 고민하고 있습니다.
- **프라이빗 서버리스 아키텍처**: 기업 환경 내에서 프라이빗 통신을 활용한 워크플로우 기반의 구성을 설계하여 확장 가능하고 안전한 애플리케이션을 만들고 있습니다.
- **오픈 소스 기여**: 취미로 다양한 오픈 소스 프로젝트에 참여하여 다양한 문제를 고민하고 의미 있는 해결책을 제공하고 있습니다.
...
- **이더리움 마이닝 (2021년 8월)**  
  여러 GPU를 사용하여 이더리움 마이닝에 참여했습니다. WMI Exporter와 Filebeat를 활용하여 종합적인 로그와 시스템 모니터링을 구현했습니다.

- **프리랜서 바이럴 마케팅 (2017년 1월 - 2019년 11월)**  
  Facebook과 Instagram에서 CPI(설치당 비용), CPC(클릭당 비용) 캠페인을 진행했습니다. 검색 엔진 최적화(SEO)에 대한 전문 지식을 활용하여 자동화된 바이럴 마케팅 프로그램을 개발했습니다.

- **생성형 AI 콘텐츠 제작**  
  Stable Diffusion, ComfyUI, Midjourney, Gen-3와 같은 생성형 AI 도구로 콘텐츠를 만드는 것을 좋아합니다.  
  *추신: 실제 콘텐츠는 공개하기 부끄러워서 유튜브나 틱톡 등에서 비공개로 활동하고 있습니다.*

- **자동화 열정가**  
  예전부터 워크플로우 기반의 자동화를 좋아했고, 요즘은 프롬프트 기반의 자동화 에이전트를 만드는 것에 재미를 붙였습니다.

---

### 📫 연락하기

대화나 협업을 원하신다면 [LinkedIn](https://www.linkedin.com/in/yongwoo-kim-b2a23a200/) 또는 [Email](mailto:wowrebong@gmail.com)로 연락해주세요.
